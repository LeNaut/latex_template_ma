...
To detach the ice layer from the sample holder, two main ideas are proposed. The first method is using mechanical force to separate the ice layer. The second idea is to design a sacrificial layer which can be dissolved at cryogenic temperatures.
