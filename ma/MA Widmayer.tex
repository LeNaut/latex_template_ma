...
\title{Development of a system for the investigaton of adhesion properties of nanoscopic ice layers at cryogenic temperatures}
%\subtitle{Subtitle}
...
\chapter{Method}
	...
	\input{texdateien/methode.tex}
	
\chapter{Results}

	\input{texdateien/ergebnisse.tex}
	
%\chapter{Discussion (VIELLEICHT IN ERGEBNISSE)}

	%\input{texdateien/diskussion.tex}
